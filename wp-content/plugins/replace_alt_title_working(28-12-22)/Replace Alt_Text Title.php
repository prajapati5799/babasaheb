...
?>
  <div>
    ...
    <button type="button" id ="LoadMore" class="btn btn-success find" id="LoadMore">Load More</button>
    <button type="button"  id ="update_data" data-action="update" onClick="get_data_ajax(event)" class="btn btn-success find_thumbnail">Update</button>
